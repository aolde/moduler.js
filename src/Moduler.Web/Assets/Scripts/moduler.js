...
(function (win, doc, $) {
        ...
        return {
            registerDomChangeEvents: function () {
                ...
                function jQueryDOMChanged(element, type) {
                    console.log('changed', type, element);
    ...
    mo.module = function(moduleName, moduleObj) {
        var obj = {};
    ...
    mo.loadModules = function(container) {
        if (container == null) {
            container = document;
        }
    ...
    mo.loadModule = function(moduleName, moduleElement, moduleObj, settings) {
